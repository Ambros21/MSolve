...
namespace ISAAR.MSolve.SamplesConsole
{
    class Program
    {
        ...
        public static void TestBeam3DElasticGeometryNonlinearNewmarkDynamicAnalysisExample()
        {
            ...
            //StaticAnalyzer parentAnalyzer = new StaticAnalyzer(provider, childAnalyzer, linearSystems);
            NewmarkDynamicAnalyzer parentAnalyzer = new NewmarkDynamicAnalyzer(provider, childAnalyzer, linearSystems, 0.25, 0.5, 0.01, 0.27); //GRAB THE MAX.
        ...
        private static void SolveHexaSoil()
        {
            ...
            NewtonRaphsonNonLinearAnalyzer childAnalyzer = new NewtonRaphsonNonLinearAnalyzer(solver, linearSystemsArray, subdomainUpdaters, subdomainMappers,
            provider, increments, totalDOFs);
            NewmarkDynamicAnalyzer parentAnalyzer = new NewmarkDynamicAnalyzer(provider, childAnalyzer, linearSystems, 0.25, 0.5, 0.1, 0.51);
        ...
        {
            //SolveHexaSoil();
            //TestBeam3DElasticGeometryNonlinearNewmarkDynamicAnalysisExample();
            //Solve(); 
