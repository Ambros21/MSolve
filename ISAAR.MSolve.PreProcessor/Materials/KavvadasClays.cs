...
namespace ISAAR.MSolve.PreProcessor.Materials
{
    public class KavvadasClays : IFiniteElementMaterial3D
    {
        ...
        public  double[,] elasticConstitutiveMatrix; //the readonly was erased due to the change of the elasticconstitutivematric regarding time
        ...
        public void DecideLoad(double[] PAR, double[] de, double[] QH, double[] Stresses, IMatrix2D<double> ConstitutiveMatrix)
        {
            for (int i = 0; i < 6; i++)
